...
var globalActions = {// [dataType]: {
	...
	}, _temp;}function withActions(OldComponent, dataType) {var WrapComponent = function WrapComponent(_ref) {var children = _ref.children,passThroughProps = _objectWithoutProperties(_ref, ['children']);return (// const { children, ...passThroughProps } = props;
