...
function callAction(dataType, method) {var _globalActions$dataTy2;for (var _len2 = arguments.length, param = Array(_len2 > 2 ? _len2 - 2 : 0), _key2 = 2; _key2 < _len2; _key2++) {param[_key2 - 2] = arguments[_key2];}return (_globalActions$dataTy2 = globalActions[dataType])[method].apply(_globalActions$dataTy2, param);} // export function getData(dataType) {
